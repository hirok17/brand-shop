    ...
    return (
        <section className="container mx-auto">
            <div className="flex justify-between items-center bg-base-100">
                <div>
                    <Link to="/" className="uppercase text-xl font-bold text-[#0F233C]">Brand <span className="text-[#EA1B25]">Shop</span> </Link>
               ...
               <div className="hidden lg:flex">
                    <div className="join">
                            ...
                            <div className="indicator">
                                ...
                                <button className="btn text-white bg-[#EA1B25] hover:bg-[#0F233C] join-item">Search</button>
                            </div>
                        </div>
               </div>
                        ...
                        <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
                            <div className="card-body">
                                ...
                                <div className="card-actions">
                                    <Link to="/cart"><button className="btn text-white bg-[#EA1B25] hover:bg-[#0F233C] btn-block">View cart</button></Link>
                                </div>
                            </div>
                        </div>
                    </div>
